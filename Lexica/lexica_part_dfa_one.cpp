...
#define TOKENS_RE         "\\#\\s*PROGRAM|;|:>|\\+|-|\\*|,|==|!=|:|\\[|\\]|\\(|\\)|\\{|\\}|<=|>=|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       "\\#\\s*PROGRAM|;|:>|\\+|-|\\*|,|=|<>|:|\\[|\\]|\\(|\\)|\\{|\\}|DATA|START|STOP|GET|PUT|IF|ELSE|GOTO|DIV|MOD|<=|>=|\\!|AND|\\|||INTEGER32"
...
#define DEFAULT_INPUT_FILE "f1.k11"
